...
(function (root, factory) {
  ...
  describe('Bus', () => {
    it('should create an instance of Bus', () => {
    ...
    it('should have the property busNumber (base name: "bus_number")', () => {
      // uncomment below and update the code to test the property busNumber
      // var instance = new KuTalaiApi.Bus();
      // expect(instance).to.be();
    });

    it('should have the property busStopId (base name: "bus_stop_id")', () => {
      // uncomment below and update the code to test the property busStopId
      // var instance = new KuTalaiApi.Bus();
      // expect(instance).to.be();
    });

    it('should have the property routeId (base name: "route_id")', () => {
