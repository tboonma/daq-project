...
(function (root, factory) {
  ...
  describe('DefaultApi', () => {
    describe('controllerGetBusRoute', () => {
      it('should call controllerGetBusRoute successfully', (done) => {
    ...
    describe('controllerGetBuses', () => {
      it('should call controllerGetBuses successfully', (done) => {
    ...
    describe('controllerGetBusstop', () => {
      it('should call controllerGetBusstop successfully', (done) => {
    ...
    describe('controllerGetBusstopWeather', () => {
      it('should call controllerGetBusstopWeather successfully', (done) => {
    ...
    describe('controllerGetBusstops', () => {
      it('should call controllerGetBusstops successfully', (done) => {
    ...
    describe('controllerGetPopulation', () => {
      it('should call controllerGetPopulation successfully', (done) => {
    ...
    describe('controllerGetRoutes', () => {
      it('should call controllerGetRoutes successfully', (done) => {
    ...
    describe('controllerGetTakableBus', () => {
      it('should call controllerGetTakableBus successfully', (done) => {
    ...
    describe('controllerPutPopulation', () => {
      it('should call controllerPutPopulation successfully', (done) => {
